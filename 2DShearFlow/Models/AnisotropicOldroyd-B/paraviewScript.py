...
cwd = os.getcwd()
outputDir = "/generated/" + cwd.split('/')[-2] + "/"
inputDir = cwd + "/"
...
glyphVectorLUT.RescaleTransferFunction(0.764306282017, 1.72754629067)

# get opacity transfer function/opacity map for 'GlyphVector'
glyphVectorPWF = GetOpacityTransferFunction('GlyphVector')

# Rescale transfer function
glyphVectorPWF.RescaleTransferFunction(0.764306282017, 1.72754629067)
